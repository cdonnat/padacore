...
/**
 * This class defines a filter which hides object directory of an Ada project.
 * 
 * @author RS
 * 
 */
public class ObjectDirectoryFilter extends AbstractProjectDirectoryFilter {

	public ObjectDirectoryFilter() {
		super();
	}
